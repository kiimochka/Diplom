...
const HomePage: React.FC = () => {
  ...
  const handleUpcomingEventClick = (event: UpcomingEvent) => {
    ...
    params.set("from", event.fromCity);
    params.set("to", event.city);
    params.set("date", event.date.split(" ")[0]);
    params.set("passengers", "1");
    params.set("tripType", "passenger");
    params.set("routeMode", "intercity");
          ...
          <div className="cargo-trust-box">
            <div className="cargo-trust-box__content">
              ...
              <p>
                ...
                доверять. Наш сервис обеспечивает:
              </p>
